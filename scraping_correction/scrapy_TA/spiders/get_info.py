...
def get_resto_avg_rating(rating):
    return rating.css('span.restaurants-detail-overview-cards-RatingsOverviewCard__overallRating--nohTl::text').extract_first()


def get_resto_nb_review(rating):
    return rating.css('a.restaurants-detail-overview-cards-RatingsOverviewCard__ratingCount--DFxkG::text').extract_first()
