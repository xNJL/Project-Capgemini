...
from scrapy_TA.items import ReviewRestoItem
...
class QuotesSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs): 
        ...
        if self.start_urls == [None]:
            self.start_urls =[
                'https://www.tripadvisor.fr/Restaurant_Review-g186338-d12156905-Reviews-Bokan_37_Restaurant-London_England.html' # zone
            ]
